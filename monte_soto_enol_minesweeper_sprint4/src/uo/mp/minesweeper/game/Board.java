...
public class Board {
	 ...
	 */
	public Board(int width, int height, int percentage, boolean test) throws GameException {
	 ...
	 * @throws GameException 
	 */
	public Board(int mines, Square[][] squares) throws GameException {
	...
	public void unveil() throws GameException {
	...
	private void uncoverWelcomeArea() throws GameException {
